...
macro(createlib)
    ...
    if(${CREATELIB_GENERATE_PACKAGE})
        ...
        set(MODULE_NAME ${CREATELIB_NAME})
        set(PACKAGE_NAME ${CREATELIB_NAMESPACE}${VERSION_MAJOR}${CREATELIB_NAME})
        set(PROJECT_NAMESPACE ${CREATELIB_NAMESPACE}${VERSION_MAJOR})
        set(PROJECT_BASE_NAME ${CREATELIB_NAME})
        set(PROJECT_DEPENDENCIES ${CREATELIB_PUBLIC_DEPS})
...
macro(createapp)
    cmake_parse_arguments(
        ...
        "CONSOLE;GENERATE_PACKAGE;REQUIRE_ADMINISTRATOR;UI_ACCESS" # list of names of the boolean arguments (only defined ones will be true)
        "NAME;NAMESPACE;VERSION" # list of names of mono-valued arguments
